...
define("tmip_stats_pending_trdata", '[ ready ] - install visitor tracker code to start logging.');
define("tmip_stats_activet_pgdata", 'active');
define("tmip_stats_pending_pgdata", '[ ready ] - install page tracker code to activate.');
define("tmip_stats_status_pagntra", 'status');
define("tmip_stats_activi_pagntra", 'status');
